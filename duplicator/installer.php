...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_institutoyduqs_cf2f83d860521ded3991_20221207232241_archive.zip';
        const ARCHIVE_SIZE       = '84116419';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'cf2f83d-07232241';
        const SECONDARY_PACKAGE_HASH = 'de61808-07232241';
        const VERSION            = '1.5.1';
